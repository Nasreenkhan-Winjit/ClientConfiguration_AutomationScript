...
//    @FindBy(how = How.XPATH, using = "/html/body/div[1]/div[43]/div/div/div[2]/div/ul/li[5]/div[1]/div[1]")
    ...
    @FindBy(how = How.XPATH, using = "//ul[contains(@class,'v-expansion-panel')]/li[5]//u[contains(text(),'Manage My Account ')]")
    private WebElement elementManageMyAccountFromAccordion;
...
//        elementCLickOnRMSTitle.getTagName();
    ...
    public void clickOnManageMyAccountViaAccordion() throws InterruptedException {
//
        webDriverWait.until(ExpectedConditions.elementToBeClickable(elementAvailableAccordion));
...
//        ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView();", elementConsignAccordion);
        ...
        scrollToElement(elementManageMyAccountFromAccordion);
        ((JavascriptExecutor) driver).executeScript("arguments[0].click();", elementManageMyAccountFromAccordion);
    }
...
//        driver.switchTo().frame(2);
    ...
    public String enterTxtKG2RONRMSPortalWeiDim(String txt) {
        ...
        return elementEnterTxtOnKG2ROnRMSWeiDim.getAttribute("value");
    ...
    public String enterTxtLength2ROnRMSPortalWeiDim(String txt) {
        ...
        return elementEnterTxtOnLength2ROnRMSWeiDim.getAttribute("value");
    }
    ...
    public String enterTxtBreadth2ROnRMSPortalWeiDim(String txt) {
        ...
        return elementEnterTxtOnBreadth2ROnRMSWeiDim.getAttribute("value");

    }

    public String enterTxtHeightRMSPortalWeiDim(String txt) {
        ...
        return elementEnterTxtHeightOnRMS.getAttribute("value");


    }

    public String enterTxtHeight2ROnRMSPortalWeiDim(String txt) {
        ...
        return elementEnterTxtOnHeight2ROnRMSWeiDim.getAttribute("value");
